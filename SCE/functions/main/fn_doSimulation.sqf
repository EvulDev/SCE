...
_vehicle setVariable [QGVAR(hasSimulatedCargo1),_simulatedCargo1,true];
...
_vehicle setVariable [QGVAR(hasSimulatedCargo2),_simulatedCargo2,true];
...
_vehicle setVariable [QGVAR(hasSimulatedCargo3),_simulatedCargo3,true];
